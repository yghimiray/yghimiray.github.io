...
/* 
 Q1. Create the function topSalary(salaries) that returns the name of the top-paid person.
...
/* Q3. European countries have days of week starting with Monday (number 1), then Tuesday (number 2) and till 
...
/* Q4.  Create a function getDateAgo(date, days) to return the day of month days ago from the date.
For instance, if today is 20th, then getDateAgo(new Date(), 1) should be 19th and getDateAgo(new Date(), 2) 
should be 18th. Should work reliably for days=365 or more:
*/
...
/* Q5.   Write a function getLastDayOfMonth(year, month) that returns the last day of month. Sometimes 
it is 30th, 31st or even 28/29th for Feb. 
Parameters:
...
/* Q6.   Write a function formatDate(date) that should format date as follows:
